...
public class GUIController {
    ...
    public GUIController() { // GUI Field creation
        ...
        fields[1] = new GUI_Street("Chance", "You got the Tower, now make it Shower!","", "+82",Color.yellow, Color.BLACK);
        fields[2] = new GUI_Street("Balloon Stand","You got the Tower, now make it Shower!","", "+82",Color.pink, Color.BLACK);
        ...
        fields[11] = new GUI_Street("Merry-Go-Round", "You got the Tower, now make it Shower!","", "+82",Color.RED, Color.BLACK);
        fields[12] = new GUI_Street("Paddle Boats", "You got the Tower, now make it Shower!","", "+82",Color.RED, Color.BLACK);
        fields[13] = new GUI_Street("Green Line Railroad", "You got the Tower, now make it Shower!","", "+82",Color.GREEN, Color.BLACK);
        ...
        fields[17] = new GUI_Street("Chance", "You got the Tower, now make it Shower!","", "+82",Color.yellow, Color.BLACK);
        fields[18] = new GUI_Street("Video Arcade", "You got the Tower, now make it Shower!","", "+82",Color.magenta, Color.BLACK);
